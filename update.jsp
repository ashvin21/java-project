<%-- 
    Document   : pupdate
    Created on : 17 Jul, 2017, 1:17:02 AM
    Author     : Ashvinee
--%>
...
if(session.getAttribute("email") != null){
        ...
        %>
<%@page import="demo.MyJavaBean, demo.MyBeanProduct"%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.html">Barcode Generator</a></h1>
			</div>
	...
	<div class="register">
		...
		<jsp:setProperty property="*" name="mybean"/>
                <%
                    ...
                    MyBeanProduct myprobean = new MyBeanProduct();
                    myprobean.find(pid);
                    session.setAttribute("myprobean", myprobean);
                %>
			<h2>Update Here</h2>
		...
		<input type="text"  disabled value="<%=mybean.getLicense()%>" ><br/>
                    ...
                    <input type="text" placeholder="Product Name" name="product" required value="<%=myprobean.getProduct() %>"> <br/>
                    <input type="text" placeholder="Product Id" name="productid" disabled="disabled" value="<%=myprobean.getProductid() %>"> <br/>
                      <input type="text" placeholder="Product price" name="price" required  value="<%=myprobean.getPrice() %>"><br/>
                      <input type="text" placeholder="Mfg.date 17/12/2019" name="mdate" required  value="<%=myprobean.getMdate() %>"><br/>
                      <input type="text" placeholder="Exp.date 19/12/2019" name="edate" required  value="<%=myprobean.getEdate() %>"><br/>

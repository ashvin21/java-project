	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><img src="images/phone.gif" height="55px" width="55px"></i>+91 7501731397</li>
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="contact.jsp">Contact</a></li>
                                      <li class="active"><a href="registered.jsp"> Create Account </a></li>
	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form name="login" action="signup.jsp" method="post" onsubmit="return validateForm()">
					<input type="text" placeholder="Company Name..." name="name" required ><br/>
					<input type="text" placeholder="Email" name="email" required >
                    <input type="password" placeholder="password" name="password" required><br/>
                    <input type="text" placeholder="Contact no." name="contact" maxlength="10" minlength="10" required><br/>
                    <input type="text" placeholder="License no." name="license" required><br/>
                    <input type="text" placeholder="Batch no." name="batch" required><br/>

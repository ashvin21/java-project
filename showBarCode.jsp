<%-- 
    Document   : showBarCode
    Created on : Jul 18, 2017, 7:14:17 AM
    Author     : Nazir
--%>
...
<br><br><br><br>
    ...
    PreparedStatement ps = con.prepareStatement("select productid,product,barcode from productdetails2 where product= ?");
    ...
    String pid=null;
     ...
     %>
          <th>
          <center><img src="displayimg.jsp?name=<% out.print(pid);%>" width="180px" height="80px"></th></center>

...
<%
    ...
    PreparedStatement ps = con.prepareStatement("select * from productdetails2 where cname= ?");
    ps.setString(1, mybean.getName());
    ResultSet rs = ps.executeQuery();
%>

 
<center>Select Product id <br><br>
    <form action="showBarCode.jsp" method="get">
            <select name="name" style="width: 150px; height:30px">  
                <%
      ...
      while(rs.next())
      {
          pid = rs.getString("productid").toString();
                   
      %>
      
    <option value="<%out.print(rs.getString(1).toString());%>"><%out.print(rs.getString(1).toString());%></option>
    <%        } %>            
